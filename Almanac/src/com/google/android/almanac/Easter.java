 ...
 * d� direttamente la data della Pasqua. L'anno di cui si calcola la Pasqua
 * sia contrassegnato da Y; mod � l'operatore modulo che restituisce il resto
 * della divisione fra numeri interi (ad esempio, 13 mod 5 = 3 perch� 13
 ...
 * marzo, altrimenti si verificher� il (d + e - 9)-esimo giorno del mese di
 * aprile.
 * 
 * Si tenga tuttavia conto delle seguenti eccezioni:
 * 
 * Se la data risultante dalla formula � il 26 aprile, allora la Pasqua
 * cadr� il giorno 19 aprile; Se la data risultante dalla formula � il 25
 * aprile e contemporaneamente d = 28, e = 6 e a > 10, allora la Pasqua cadr�
 * il 18 aprile.
 * 
