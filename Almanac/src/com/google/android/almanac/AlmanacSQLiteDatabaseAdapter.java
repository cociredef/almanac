...
public class AlmanacSQLiteDatabaseAdapter extends SQLiteOpenHelper{
	 ...
	 */
	private AlmanacSQLiteDatabaseAdapter(Context context, String name, CursorFactory factory, int version) {  
	...
	private static void initialize(Context context,String databaseName) {  
		if(instance == null) {  
			...
			instance = new AlmanacSQLiteDatabaseAdapter(context, databaseName, null, DATABASE_VERSION);
	 ...
	 */
	public static final AlmanacSQLiteDatabaseAdapter getInstance(Context context,String databaseName) {  
