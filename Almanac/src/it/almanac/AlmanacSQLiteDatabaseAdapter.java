//Copyright 2008 Alessandro Franzi
//
...
public class AlmanacSQLiteDatabaseAdapter extends SQLiteOpenHelper {
	 ...
	 *            : DB version
	 */
	private AlmanacSQLiteDatabaseAdapter(Context context, String name,
	...
	private static void initialize(Context context, String databaseName) {
		if (instance == null) {
			...
			Log.i(TAG, "Try to create instance of database (" + databaseName
					+ ")");
			instance = new AlmanacSQLiteDatabaseAdapter(context, databaseName,
	 ...
	 */
	public static final AlmanacSQLiteDatabaseAdapter getInstance(
